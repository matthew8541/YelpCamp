...
// deal with invalid sql injection from the url input
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/ytseng35/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
// use mongo to store cookies/sessions
const sessionConfig = {
  store,
  name: "session",
  secret,
  ...
  cookie: {
    httpOnly: true,
    // secure: true, // only included when deployed
